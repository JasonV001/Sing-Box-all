...
@@ -25,33 +26,10 @@ SHADOWTLS_LINKS_FILE="${LINK_DIR}/shadowtls.txt"
...
@@ -125,61 +115,31 @@ LimitNOFILE=infinity
[Install]
...
# Sing-box 密钥文件
UUID="${UUID}"
@@ -193,1735 +153,155 @@ ANYTLS_PASSWORD="${ANYTLS_PASSWORD}"
